...
*/
public class BlazegraphServiceVertxProxyHandler extends ProxyHandler {

  public static final long DEFAULT_CONNECTION_TIMEOUT = 5 * 60; // 5 minutes 

  private final Vertx vertx;
  private final BlazegraphService service;
  private final long timerID;
  private long lastAccessed;
  private final long timeoutSeconds;

  public BlazegraphServiceVertxProxyHandler(Vertx vertx, BlazegraphService service) {
  ...
  public BlazegraphServiceVertxProxyHandler(Vertx vertx, BlazegraphService service, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
